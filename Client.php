...
class Client
{
    ...
    {
        $sql = 'INSERT INTO shop(id, name, phone) VALUES(:id, :name, :phone)';
        $stmt = $this->pdo->prepare($sql);
    ...
    public function update(int $id, $name, $phone): array
    {
        return $this->query("UPDATE $this->table SET (name, phone) = ('$name','$phone')  WHERE id = $id");
    }
